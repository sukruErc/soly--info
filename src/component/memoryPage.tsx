...
const MemoryPage = () => {
    ...
    const downloadImage = async () => {
        const res = await axios.post('http://localhost:3500/v1/memory-ticket/generate-memory-image', {
    ...
    return (
        <div className={styles.logoImg}>
            ...
            >
                ...
                <h1 className="text-red-500 text-2xl font-mono">29 Ekim Hatıra Bileti</h1>
